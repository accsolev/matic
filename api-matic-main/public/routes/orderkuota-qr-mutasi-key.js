const { OrderKuotaKey } = require('../../lib/orderkuota-key-logic.js');
...
module.exports = async function(req, res) {
    try {
        ...
        const keyApi = new OrderKuotaKey();
        const result = await keyApi.getKasirSessionKey(auth_token, auth_username);
