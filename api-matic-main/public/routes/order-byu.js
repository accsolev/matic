const { OrderKuotaByu } = require('../../lib/orderkuota-byu-logic.js');
...
module.exports = async function(req, res) {
    try {
        ...
        const byuApi = new OrderKuotaByu();
        const result = await byuApi.orderByu(auth_token, auth_username, voucher_id, target_number);
