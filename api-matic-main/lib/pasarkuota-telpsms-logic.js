...
class PasarKuotaTelpSms {
    ...
    async getTelpSmsProducts(authToken, authUsername) {
        const payload = new URLSearchParams({
            ...this.BASE_PAYLOAD,
            'auth_token': authToken,
            'auth_username': authUsername,
            'requests[vouchers][product]': 'telp_sms',
    ...
    async orderTelpSms(authToken, authUsername, voucherId, targetNumber) {
        const payload = new URLSearchParams({
            ...this.BASE_PAYLOAD,
            'auth_token': authToken,
            'auth_username': authUsername,
...
module.exports = { PasarKuotaTelpSms };
