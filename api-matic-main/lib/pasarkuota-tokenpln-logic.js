...
class PasarKuotaTokenPln {
    ...
    async getTokenPlnProducts(authToken, authUsername) {
    ...
    async orderTokenPln(authToken, authUsername, voucherId, targetNumber, registeredPhone) {
        const payload = new URLSearchParams({
            ...this.BASE_PAYLOAD,
            'auth_token': authToken,
            'auth_username': authUsername,
...
module.exports = { PasarKuotaTokenPln };
